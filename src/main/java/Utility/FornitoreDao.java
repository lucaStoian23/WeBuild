...
*/
    ...
    public static void deleteFornitoreWithRagSociale(String Nome) throws SQLException {
        ...
        if (connection != null) {
            System.out.println("Connection to HANA successful!");
            PreparedStatement pst =connection.prepareStatement("DELETE from npp.fornitore where RAGSOCIALE = ?");
