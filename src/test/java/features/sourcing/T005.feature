Feature: T005 Assegnare RDA a buyer, far creare al buyer una rfx di tipo RDQ e farla approvare al VM
  Scenario Outline: T005 Assegnare RDA a buyer, far creare al buyer una rfx di tipo RDQ e farla approvare al VM
