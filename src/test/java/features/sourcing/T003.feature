Feature: T003 Assegnare RDA a buyer, far creare al buyer una rfx di tipo RDI e farla approvare al VM,
  Scenario Outline: T003 Assegnare RDA a buyer, far creare al buyer una rfx di tipo RDI e farla approvare al VM,
