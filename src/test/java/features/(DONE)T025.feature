Feature: T025 creazione fornitore procurement and qualification
  Scenario Outline: T025 creazione fornitore procurement and qualification
...
#TIPOLOGIE FORNITORE:  0 = AFC/ 1 = PROCUREMENT / 2 = PROCUREMENT & QUALIFICA
    ...
    #invio della proposta e controllo Registered AFC
    ...
    #aggiungo un progetto (pjr senza locale)
    And I check that AnagraficaFornitore.TabCommodityAndProject is displayed
    ...
    #dovrebbe selezionare il progetto "pjr senza locale" ma non è presente
