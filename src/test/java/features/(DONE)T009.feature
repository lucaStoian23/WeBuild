...
#creo il contatto primario
 ...
 #aggiungo un progetto
    ...
    And I select the 0 element from the DDL AnagraficaFornitore.AddRequestUL
    And I check that AnagraficaFornitore.CeasedNotes is displayed
    And I input in AnagraficaFornitore.CeasedNotes the text 'Nota Test'
    And I check that AnagraficaFornitore.CeasedAddFile is displayed
    And I put the attachment extent-config.xml inside AnagraficaFornitore.CeasedAddFile
    And I check that AnagraficaFornitore.CeasedFileDescription is displayed
    And I input in AnagraficaFornitore.CeasedFileDescription the text 'Test'
    And I check that AnagraficaFornitore.CeasedAddButton is displayed
    And I click AnagraficaFornitore.CeasedAddButton
    And I check that General.OKMessage is displayed
    And I click General.OKMessage
 ...
 #   #Check Status Finale
    ...
    Examples:
      ...
      | "GTFSLA41A73AB5F9Z" | ""            | "009341609415"  | "TestVendor09"     |