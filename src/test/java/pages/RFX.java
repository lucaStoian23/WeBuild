...
public class RFX {
   ...
   // public static final BrowserElement CapexPL = new BrowserElement(new By[]{By.id("application-NPPNewRFX-Display-component---NewRFXDetail--IDNewRFXCapex-inner")});
    ...
    public static final BrowserElement InviaVendorListPerApprovazione = new BrowserElement(new By[]{By.xpath("//bdi[@id='application-NPPNewRFX-Display-component---NewRFXDetail--IDNewRFXDetailApprovalBtn-BDI-content']")});
