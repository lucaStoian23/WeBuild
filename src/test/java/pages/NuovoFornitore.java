...
public class NuovoFornitore {
    ...
    public static final BrowserElement RagioneSociale = new BrowserElement(new By[]{By.xpath("//input[@placeholder='Inserisci ragione sociale']")});
    public static final BrowserElement PartitaIva = new BrowserElement(new By[]{By.xpath("//input[@placeholder='Inserisci la partita IVA...']")});
    public static final BrowserElement CodiceFiscale = new BrowserElement(new By[]{By.xpath("//input[@placeholder='Codice fiscale...']")});
    public static final BrowserElement PartitaIvaCEE = new BrowserElement(new By[]{By.xpath("//input[@placeholder='Inserisci la partita IVA comunitaria...']")});
