...
public class AnagraficaFornitore {
    ...
    public static final BrowserElement ValutaDiRiferimentoDDL = new BrowserElement(new By[]{By.id("application-NPPFornitori-Display-component---SupplierCreationData--infosupplierblock-Collapsed--nationDialog-list-listUl")});
    public static final BrowserElement SitoWeb = new BrowserElement(new By[]{By.id("application-NPPFornitori-Display-component---SupplierCreationData--infosupplierblock-Collapsed--website-inner")});
    public static final BrowserElement InviaProposta = new BrowserElement(new By[]{By.id("application-NPPFornitori-Display-component---SupplierCreationData--_IDGenButton1")});
    public static final BrowserElement AggiungiCommodity = new BrowserElement(new By[]{By.id("application-NPPFornitori-Display-component---SupplierCreationData--commodityprojectblock-Collapsed--id_suppliercommodityblocktab_Table_HeaderToolbar_ButtonAddNew")});
    public static final BrowserElement AggiungiProgetti = new BrowserElement(new By[]{By.id("application-NPPFornitori-Display-component---SupplierCreationData--commodityprojectblock-Collapsed--id_supplierprojectblocktab_Table_HeaderToolbar_ButtonAddNew-content")});
    ...
    public static final BrowserElement NuovoContatto = new BrowserElement(new By[]{By.id("application-NPPFornitori-Display-component---SupplierCreationData--contactblock-Collapsed--idNewUsrBtn")});
